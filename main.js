...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  renderView() {
    ...
    switch (path) {
      ...
      case 'practice':
        return this.state.cards.length > 1 ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_practice__WEBPACK_IMPORTED_MODULE_6__["default"], {
          cards: this.state.cards
        }) : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_cards_list__WEBPACK_IMPORTED_MODULE_2__["default"], {
          cards: this.state.cards
        });
